// rebl-calculator.js -- Enhanced Calculator JavaScript v3.2 - FIXED
...
function toggleFormulaDetails() {
    console.log('toggleFormulaDetails called');
