...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚨 Applying emergency mobile fix...');
    
    // Force mobile menu to reset
    const navDesktop = document.getElementById('nav-desktop');
    const mobileToggle = document.getElementById('mobileNavToggle');
    
    if (navDesktop && mobileToggle) {
        // Remove all inline styles that might be causing issues
        navDesktop.removeAttribute('style');
        
        // Re-add click event with fresh listener
        mobileToggle.onclick = function(e) {
            ...
            if (isOpening) {
                ...
                document.body.classList.add('nav-open');
                this.setAttribute('aria-expanded', 'true');
                console.log('📱 Mobile menu opened (emergency)');
            } else {
                navDesktop.classList.remove('active');
                this.classList.remove('active');
                document.body.classList.remove('nav-open');
                this.setAttribute('aria-expanded', 'false');
                console.log('📱 Mobile menu closed (emergency)');
            }
        };
